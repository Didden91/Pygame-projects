...
def playerattack(move, enemyhp):
    ...
    enemies.sprite.get_damage(damage)
    enemies.update()
...
class Enemy(pygame.sprite.Sprite):
    ...
    def advanced_health(self):
        ...
        pygame.draw.rect(DISPLAYSURF,(255,255,255),(10,45,self.health_bar_length,25),4)	   
...
def draw_background():
    ...
    enemyHBsurf = pygame.Surface((enemyhp, 30))
        #Fill the surface with a color
